    ...
    it('renders the component without number of occurrences properly', () => {
        ...
        expect(
            wrapper
                ...
                .at(0)
                .props().id,
        ).toEqual('machinery-TranslationMemory--pontoon-homepage');
        ...
        expect(
            wrapper
                ...
                .at(1)
                .props().id,
        ).toEqual('machinery-TranslationMemory--translation-memory');
    ...
    it('renders the component with number of occurrences properly', () => {
        ...
        expect(
            wrapper
                ...
                .at(2)
                .props().id,
        ).toEqual('machinery-TranslationMemory--number-occurrences');
